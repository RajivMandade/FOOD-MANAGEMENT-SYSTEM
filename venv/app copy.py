...
def infoorders():
    ...
    cursor.close()
    return render_template("orders.html",sdata=sdata,menu=menu)
...
def placeorders():
    ...
    try:
        ...
        if request.method=='POST'and 'orders' in request.form:
            ...
            cursor.close()
            return render_template("orders.html",data=data,msg=msg,rec=rec,total=total)
    except:
        return "Errror"
...
def delorder():
    ...
    return render_template("delete.html",data=data,msg=msg)
